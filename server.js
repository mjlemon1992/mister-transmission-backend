...
html: "<h2>New Customer Check-In</h2><p><strong>Name:</strong> " + customer.firstName + "
});
}
...
{ firstName: b.firstName, lastName: b.lastName, phone: b.phone, email: b.email, ref
{ year: b.year, make: b.make, model: b.model },
orderId
).then(function() {
res.json({ success: true, customerId: customerId, vehicleId: vehicleId, orderId: or
});
});
});
}).catch(function(err) {
